...
/**
 * Chmury — single-div multi-background, mix-blend-mode:screen PER CLOUD.
 *
 * Dlaczego per-cloud a nie per-container:
 *   Kontener 100vw × ~1000vh z blend mode = 1 ogromny GPU texture → pixeloza.
 *   Każda chmura osobno (~620×190px) = mały, czysty compositing unit → brak artefaktów.
 *
 * Każda chmura: kilka elips radial-gradient jako background-image layers.
 * Zero nested abs-positioned divów → zero sub-pixel kompozytowania dzieci.
 * Screen blend: biały na ciemnym tle = jasne chmury, zero wpływu na przezroczyste obszary.
 * Hero 0–100vh wolne od chmur. Zdjęcia (Instructors/Courses/Gallery) z-index:2.
 */
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        width: w, height: h,
        pointerEvents: 'none',
        // screen PER CLOUD: małe, niezależne compositing unity bez pixelozy
        mixBlendMode: 'screen',
        ...S[s],
      }}
      animate={{ x: dx, y: dy }}
  ...
  return (
    <div
      ...
      style={{
        ...
        // BRAK mix-blend-mode na kontenerze — to był źródłem pixelozy
      }}
    >
      {/* ── Hero 0–100vh: cloud-free ──────────────────────────── */}
      ...
      {/* ── Instructors + Locations ~258–405vh ── */}
